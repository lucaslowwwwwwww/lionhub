      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 border-b border-surface-800 pb-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <input type="date" value={currentActualDate.toISOString().split('T')[0]} onChange={handleDateChange} className="bg-surface-900 border border-surface-800 rounded-lg px-3 py-1.5 text-sm font-bold text-crimson-400" />
          </div>
